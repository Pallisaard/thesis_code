from thesis_code.models.vaes.vanilla_vae import VAE
...
from thesis_code.models.vaes.VQVAE.VQVAE import VQVAE
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(dataset)  # type: ignore # Create DataLoader
