#!/bin/bash
#SBATCH --job-name=finetune_dp_e5 # Name of the job
#SBATCH --output=slurm_finetune_dp_e5-%j.out # Name of output file
#SBATCH --error=slurm_finetune_dp_e5-%j.err # Name of error file
#SBATCH --gres=gpu:a100:1       # Request 4 GPU per job
#SBATCH --time=1-12:00:00       # Time limit day-hrs:min:sec
...
CUDA_LAUNCH_BLOCKING=1 python -m thesis_code.training.fine_tuning.finetune  --latent-dim 1024 \
                ...
                --checkpoint-path checkpoints/finetuned/dp-epsilon-5 \
