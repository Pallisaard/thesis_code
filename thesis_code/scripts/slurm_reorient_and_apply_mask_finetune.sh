...
python -m thesis_code.scripts.apply_mask_to_mris --data-dir ../data/fine-tuning/fs_scans/ --output-dir ../data/fine-tuning/brain-masked --fastsurfer-output-dir ../fastsurfer-output/fine-tuning/
