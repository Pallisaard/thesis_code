...
python -m thesis_code.scripts.apply_mask_to_mris --data-dir ../data/fine-tuning/not-brain-masked/ --output-dir ../data/fine-tuning/brain-masked-new --fastsurfer-output-dir ../fastsurfer-output/fine-tuning/
