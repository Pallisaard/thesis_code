...
python -m thesis_code.data_collection.apply_mask_to_mris --data-dir ../data/pre-training/brain-masked/ --fastsurfer-output-dir ../fastsurfer-output/pre-training/ --percent-outliers 0.005