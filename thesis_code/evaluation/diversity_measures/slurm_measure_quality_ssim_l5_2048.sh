#!/bin/bash
#SBATCH --job-name=measure_quality_ssim_l5_2048 # Name of the job
#SBATCH --output=measure_quality_ssim_l5_2048-%j.out # Name of output file
#SBATCH --error=measure_quality_ssim_l5_2048-%j.err # Name of error file
