#!/bin/bash
#SBATCH --job-name=measure_quality_ssim_l1_512 # Name of the job
#SBATCH --output=measure_quality_ssim_l1_512-%j.out # Name of output file
#SBATCH --error=measure_quality_ssim_l1_512-%j.err # Name of error file
