...
#SBATCH --dependency=afterany:5117:5116:5118:5119
...
if [ $SLURM_ARRAY_TASK_ID -eq 1 ]; then
  ...
  python -m thesis_code.evaluation.generate_samples.vectorize_test_dataset --data-dir ../data/pre-training/brain-masked-zerosliced-64 \
